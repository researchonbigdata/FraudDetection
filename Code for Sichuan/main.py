...
def main():
    ...
    train_id = np.load(
        'Data_processing/train_ids.npy')
    test_id = np.load(
        'Data_processing/test_ids.npy')

    num_node = len(train_id)+len(test_id)
    train_index = len(train_id)

    oneweek = np.load(
        f'Data_processing/x_train_1.npy')
    twoweek = np.load(
        f'Data_processing/x_train_2.npy')
    threeweek = np.load(
        f'Data_processing/x_train_3.npy')
    month = np.load(
        f'Data_processing/x_train_4.npy')
    id_feature = np.load(
        f'Data_processing/id_x_train.npy')
    label = np.load(
        f'Data_processing/y_train.npy')
    ...
    oneweek2 = np.load(
        f'Data_processing/x_test_1.npy')
    twoweek2 = np.load(
        f'Data_processing/x_test_2.npy')
    threeweek2 = np.load(
        f'Data_processing/x_test_3.npy')
    month2 = np.load(
        f'Data_processing/x_test_4.npy')
    id_feature2 = np.load(
        f'Data_processing/id_x_test.npy')
    label2 = np.load(
        f'Data_processing/y_test.npy')
    ...
    source = np.load(
        'Data_processing/source_1p.npy')
    target = np.load(
        'Data_processing/target_1p.npy')
    tmps = source.copy()
    tmpt = target.copy()
